...
// Concurrent Solution
// 1. RwLock<TimeMap> or Mutex<TimeMap>
...
// 5. (R >> W) Immutable snapshots + copy-on-write — use Arc<BTreeMap> and atomically swap the pointer on writes; readers clone the Arc and read without locking. Works well when reads vastly outnumber writes.